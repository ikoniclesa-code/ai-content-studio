...
AI: GPT-5.4 (tekst) \| Gemini 3 Pro (slike) \| Veo 3.1 Lite (video)
...
-   Podesi Webhook endpoint: https://tvoj-domen.com/api/webhooks/stripe
...
Koristi Gemini 3 Pro iskljucivo. Kosta 14 kredita po generisanju.
...
Koristi Veo 3.1 Lite iskljucivo. Kosta 60 kredita po generisanju.
...
**7.4 Kreditni sistem --- cene**
  ...
  **Tip generisanja**   **Krediti**   **AI model**       **Priblizna cena po generisanju**
  ...
  Slika                 14 kredita    Gemini 3 Pro       \~\$0.28

  Video                 60 kredita    Veo 3.1 Lite       \~\$1.20
  --------------------- ------------- ------------------ -----------------------------------
